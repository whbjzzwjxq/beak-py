...
fn main() {
    ...
    stdin.write(&149516602u32);
    stdin.write(&1830488436u32);
    stdin.write(&1282933296u32);
    stdin.write(&3038446964u32);
    stdin.write(&3621520412u32);
    stdin.write(&2073488173u32);
    stdin.write(&811159297u32);
